...
def get_site_setting(key, default='0'):
    """دریافت مقدار یک تنظیمات سایت"""
    conn = get_db()
    cursor = conn.cursor()
...
def is_maintenance_mode():
    """بررسی وضعیت تعمیرات (True = فعال، False = غیرفعال)"""
    return get_site_setting('maintenance_mode', '0') == '1'
